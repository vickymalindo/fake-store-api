...
const Login = () => {
    ...
    return (
        <>
            ...
            : 
            <div className="w-full h-screen flex flex-col items-center justify-center bg-gray-400 px-5 md:px-0">
                        ...
                        <div className="w-full mb-2">
                            <div className="flex items-center">
                                <input type='text' placeholder="Username"
                                    className="-mx-6 px-8  w-full border rounded py-2 text-gray-700 focus:outline-none" onChange={(e) => setUsername(e.target.value)} />
                            </div>
                        </div>
                        <div className="w-full mb-2">
                            <div className="flex items-center">
                                <input type='password' placeholder="Password"
                                    className="-mx-6 px-8 w-full border rounded py-2 text-gray-700 focus:outline-none" onChange={(e) => setPassword(e.target.value)} />
                            </div>
                        </div>
                        <button type="submit"
