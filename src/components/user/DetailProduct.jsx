          ...
          <div>
            ...
            <div className="mt-3">
              ...
              <div className="flex items-center gap-3 mt-3">
                <button className="flex items-center gap-1 border border-green-500 bg-green-200 px-3 py-2 text-green-500 rounded-sm" onClick={addToCart}><FaCartPlus className="text-green-500" /> Add to Cart</button>
